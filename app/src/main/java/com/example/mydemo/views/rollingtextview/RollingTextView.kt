...
package com.example.mydemo.views.rollingtextview
...
import com.example.mydemo.views.rollingtextview.strategy.CharOrderStrategy
import com.example.mydemo.views.rollingtextview.strategy.Strategy
...
open class RollingTextView : View {
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        fun applyTypedArray(arr: TypedArray) {
            ...
            textBgColor = arr.getColor(R.styleable.RollingTextView_textBgColor, textBgColor)
    ...
    private fun realignAndClipCanvasForGravity(canvas: Canvas) {
        ...
        canvas.clipRect(-5f, 0f, currentWidth+5, currentHeight+10)
    ...
    var textBgColor: Int = Color.GRAY
    set(color){
        if (field != color) {
            field = color
            textManager.textBgColor = color
            invalidate()
        }
    }
    get() = textManager.textBgColor


    var showCharBg: Boolean
        set(value){
            textManager.showCharBg = value
        }
        get() = textManager.showCharBg
    /**
     * px between letter
     */
